  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-status-danger-bg",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      className={cn(
        "relative flex cursor-pointer select-none items-center gap-2 rounded-sm py-1.5 pl-8 pr-2 text-[13px] outline-none transition-colors focus:bg-muted",
        className,
      )}
      checked={checked}
      {...props}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      data-inset={inset}
      className={cn(
        "flex cursor-pointer select-none items-center rounded-sm px-2 py-1.5 text-[13px] outline-none focus:bg-muted data-[inset]:pl-8",
        className,
      )}
      {...props}
    >
