...
import type { ClientOption, ProfileOption, ProjectFilters } from "@/lib/data/projects";
...
export function ProjectFiltersBar({ filters, onChange, clients, profiles }: ProjectFiltersBarProps) {
